...
node = QualibrationNode(name="05c_T1_under_iSWAP", parameters=Parameters())
...
qq_interaction_flux = machine.qubit_pairs['q0_q2'].gates.iSWAP.flux_pulse_control.amplitude
    ...
    for i, qubit in enumerate(qubits):
        ...
        with for_(n, 0, n < n_avg, n + 1):
            ...
            with for_(*from_array(t, idle_times)):
                ...
                qubit.align()
                qubit.z.wait(20)
                machine.qubits['q2'].z.play('const',duration=t, amplitude_scale=qq_interaction_flux / qubit.z.operations["const"].amplitude)
                qubit.z.wait(20)
                qubit.align()
...
if not node.parameters.simulate:
    if node.parameters.load_data_id is None:
        ...
        if node.parameters.use_state_discrimination == False:
