...
for a in alpha_list:
    ...
    node = QualibrationNode(name="10d_Single_Qubit_Randomized_Benchmarking_imperfect", parameters=Parameters())
    ...
    if node.parameters.simulate:
        ...
        job = qmm.simulate(config, RB1qAlphas(1), simulation_config)
