...
#%%
sweep_time = np.arange(102,111,2).tolist()
for aa in sweep_time:
    ...
    if Parameters().load_data_id is not None:
        ...
        node = QualibrationNode(name=f"101a_Random_state_ellipsoid_swap_qubit1ns_{aa}ns", parameters=Parameters())
