...
node = QualibrationNode(name="07b_IQ_Blobs_debug", parameters=Parameters())
    ...
    for i, qubit in enumerate(qubits):
        ...
        with for_(n, 0, n < n_runs, n + 1):
            ...
            if reset_type == "active":
                active_reset(qubit, readout_pulse_name = "readout",max_attempts=15,wait_time=4)
...
with open("debug.py","w") as f:
    f.write(generate_qua_script(iq_blobs,config))
